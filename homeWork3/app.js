...
let listAllFoods = () => {
  ...
  menu.map(item => {
    allFoods += foodsCreatorFunc(item)
  });
...
let chineseFoods = () => {
  ...
  menu.map(item => {
    if (item.category === "China") {
      chinaFoods += foodsCreatorFunc(item)
    }
  });
...
let japaneeseFoods = () => {
  ...
  menu.map(item => {
    if (item.category === "Japan") {
      japanFoods += foodsCreatorFunc(item)
    }
  });
...
let koreanFoods = () => {
  ...
  menu.map(item => {
    if (item.category === "Korea") {
      koreaFoods += foodsCreatorFunc(item)
    }
  }
  );
...
document.querySelector("#japan").addEventListener("click", japaneeseFoods);
